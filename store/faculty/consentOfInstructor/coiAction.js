...
export const actions = {
    async getApplications ({ dispatch, commit }, payload) {
        ...
        try {
            const data = await this.$axios.$get(`/faculties/consent-of-instructor`, {params: {
    ...
    async updateApplication({state, dispatch, commit}, payload) {
        ...
        try {
            const data = await this.$axios.$put(`/faculties/consent-of-instructor/${state.for_action.coi_id}`, {
                class_nbr: payload.class_nbr,
