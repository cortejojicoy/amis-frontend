<template>
  <div
    ...
    <!-- <div class="bg-gray-200 absolute overflow-y-scroll w-full h-full p-8 slider z-10" :class="{'slider-open': openStudentView}">
        <div>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div>
          <div class="mb-4 flex items-center">
            <div class="text-2xl">Mentor Assignment (Faculty)</div>
          </div>
        </div>
        ...
        <div class="mb-4">
          <div class="flex lg:nowrap flex-wrap w-full justify-between">
            ...
            <div class="flex items-end">
              <button class="text-white text-small p-1 bg-blue-500">
                Apply Filter
              </button>
            </div>
          </div>
